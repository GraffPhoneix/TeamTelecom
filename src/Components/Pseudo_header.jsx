...
export default function PseudoHeader() {
    ...
    return (
        <header className="bg-white shadow-md border-b border-gray-100 h-16">
            <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
                <nav className="flex items-center space-x-6 text-sm font-medium">
                    ...
                    <a href="/shake" className="text-gray-700 hover:text-red-600 transition pb-4.5">Шейкай и Выигрывай!</a>
                </nav>
                <a href="/busket" className="relative flex items-center px-4 py-2 bg-[#01415f] text-white rounded-2xl shadow-md hover:shadow-lg hover:scale-[1.03] transition mb-4.5">
                    ...
                    <span className="absolute -top-2 -right-2 bg-white text-[#01415f] text-xs font-bold px-2 py-0.5 rounded-full shadow-sm">{productsInBusket}</span>
                </a>
            </div>
        </header>
    );
