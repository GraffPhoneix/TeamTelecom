...
export default function BusketProducts() {
    ...
    const typeNames = {
        "#smartphone": "Телефоны и планшети",
        "#device": "Устройства",
        "#accsesories": "Аксессуары",
    };
    ...
    const total = basketProducts.reduce(
        (sum, p) => sum + parsePrice(p.price) * (p.qty || 1),
        0
    );
            ...
            <div className="max-w-7xl mx-auto px-10">
                {basketProducts.length > 0 ? (
                    <>
                        ...
                        <div className="bg-white border border-[#ebedef] rounded-md shadow-none mt-8">
                            <div className="p-4 border-b border-[#ebedef] text-md text-[#2C3843]">
