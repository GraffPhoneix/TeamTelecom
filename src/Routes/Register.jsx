    ...
    return (
        <div className="max-w-md mx-auto bg-white border border-gray-200 rounded-lg shadow-lg p-8 mt-12 mb-4">
            ...
            <form className="space-y-5">
                ...
                <button
                    type="submit"
                    className="border-red-500 w-full transition border-2 hover:bg-red-500 hover:text-white mt-7 cursor-pointer text-red-600 text-sm font-medium px-4 py-2 rounded-4xl"
                >
                    Зарегистрироваться
                </button>
            </form>
