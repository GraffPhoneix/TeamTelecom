        ...
        <header className="bg-white shadow-md sticky top-0 z-50">
            <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
                ...
                <nav className="hidden md:flex space-x-6 text-sm">
                    <a href="#" className="hover:text-red-600">Услуги</a>
                    <a href="#" className="hover:text-red-600">Магазин</a>
                    <a href="#" className="hover:text-red-600">Поддержка</a>
                    <a href="#" className="hover:text-red-600">Компания</a>
                </nav>
